...
| **salient push** channel: ntfy vs Discord | T3 | **converging → MVP: direct Discord (discord.py), two-way**; multi-platform frameworks (LangBot) deferred. See `exploration/gateway-selection.md` |
...
| `exploration/gateway-selection.md` | converging | operator↔agent channel; MVP = direct two-way Discord (`discord.py`); frameworks deferred |
